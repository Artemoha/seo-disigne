	...
	BX.Sale.OrderAjaxComponent = {
		...
		editAuthorizeForm: function(authContent)
		{
			...
			authFormNode = BX.create('DIV', {
				...
				children: [
					BX.create('H3', {props: {className: 'bx-title'}, html: BX.message('STOF_AUTH_REQUEST')}),
					login,
					password,
					remember,
					button,
			...
			authContent.appendChild(BX.create('DIV', {props: {className: ' block_with_form'}, children: [authFormNode]}));
		},
		...
		editSocialContent: function(authContent)
		{
			...
			authContent.appendChild(BX.create('DIV', {props: {className: 'col-md-5'}, children: nodes}));
		},
		...
		createPaySystemItem: function(item)
		{
			...
			itemNode = BX.create('DIV', {
				props: {className: 'bx-soa-pp-company col-lg-4 col-sm-4 col-xs-4'},
